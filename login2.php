...
<div class="container">
    ...
    <div class="cover">
      <div class="front">
        ...
        <div class="text">
          <span class="text-1">bienvenido <br> </span>
          <span class="text-2">inicia sesion como estudiante</span>
        </div>
      </div>
      <div class="back">
        <img class="backImg" src="img/profesor1.jpg" alt="">
        <div class="text">
          <span class="text-1">hola de nuevo <br> profesor</span>
          <span class="text-2">inicia como profesor</span>
        </div>
      </div>
    </div>
    <div class="forms">
